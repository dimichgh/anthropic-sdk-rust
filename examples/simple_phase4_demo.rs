...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!("💰 Estimated cost (500 input + 200 output): ${:.4}", estimated_cost);
    ...
    println!("📈 Recorded usage: {} input, {} output tokens", 
    ...
    println!("  • Session duration: {:.1}s", usage_summary.session_duration.as_secs_f64());
